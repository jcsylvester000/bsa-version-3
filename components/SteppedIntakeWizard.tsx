...
export function SteppedIntakeWizard({ franchisors, mockMode = false, mockRunId, editIntakeId = null }: {
  ...
  async function submit() {
    ...
    try {
      ...
      // after the first couple in a single serverless invocation. Each site's Final Report
      // recommendation is computed live from the module results — no separate write step.
      for (let i = 0; i < 30; i++) {
